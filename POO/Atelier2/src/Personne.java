...
public class Personne{
    ...
    public boolean equals(Personne p1){
        return this.getNom().equals(p1.getNom()) && this.getPrenom().equals(p1.getPrenom()) && this.getDateNaissance().equals(p1.getDateNaissance());
    }

    /**
     * Compare l'âge de 2 personnes
     * @param p1 première personne
     * @param p2 deuxième personne
     * @return true si p1 plus âgée que p2, sinon false
     */
    ...
    /**
     * Compare l'âge de la personne courante avec celui d'une autre
     * @param p1 première personne
     * @return true si personne courante plus âgée que p1, sinon false
     */
    public boolean plusAgeeQue(Personne p1){
        return this.dateNaissance.compareTo(p1.dateNaissance) < 0;
    }
